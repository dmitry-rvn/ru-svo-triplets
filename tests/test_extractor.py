...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param('Я решил отдохнуть и посмотреть новый фильм.', ['Я решил посмотреть фильм'], id='...'),
        pytest.param('Она решила найти сериал и завтра его посмотреть.', ['Она решила найти сериал', 'Она решила его посмотреть'], id='...'),
    ]
)
